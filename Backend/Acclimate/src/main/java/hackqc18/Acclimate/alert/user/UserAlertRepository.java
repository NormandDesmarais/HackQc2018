...
/**
 * Interface used to define the user alert repository. This interface
 * will automatically be instantiated as a Singleton by Spring at compile
 * time by inserting the following declaration in classes that needs
 * this repository:
 * 
 *      @Autowired
